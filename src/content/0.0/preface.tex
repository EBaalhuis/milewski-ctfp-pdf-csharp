...
Granted, you'll have to overcome some verbose syntax, the patterns might
...
generics, data structures, and algorithms. But since I can't expect the
...
frantic pace --- a new version every year --- trying to catch up
