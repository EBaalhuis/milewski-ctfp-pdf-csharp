...
I wish I could tell you that there is a helper in the C\# Standard
...
universally polymorphic. In C\# we could define it as a generic method:

\begin{snip}{csharp}
static T Id<T>(T x) => x;
\end{snip}
In C\#, a single generic definition works uniformly for every type,
whether it's a reference type or a value type, so we don't have to
worry about how the argument is passed.
